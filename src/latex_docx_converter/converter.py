...
def normalize_config(config: ConversionConfig) -> ConversionConfig:
    ...
    reference_docx = resolve_optional(config.reference_docx, project_dir)
    bibliography = resolve_optional(config.bibliography, project_dir)
    csl = resolve_optional(config.csl, project_dir)
